...
namespace WebAppRoutingHelpers.Helpers
{
    // You may need to install the Microsoft.AspNetCore.Razor.Runtime package into your project
    [HtmlTargetElement(Attributes = "asp-active-route")]
    public class RoutActiveTagHelper : TagHelper
    {
        [ViewContext]
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            if(controller == tagController && action == tagAction)
            {
                ...
                var newcssClasses = context.AllAttributes.FirstOrDefault(a => a.Name == "asp-active-route").Value.ToString();

                output.Attributes.SetAttribute("class", cssClasses + "" + newcssClasses);
            }
        }
    }
}
